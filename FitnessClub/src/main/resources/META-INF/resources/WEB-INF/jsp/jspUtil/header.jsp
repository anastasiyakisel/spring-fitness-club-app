...
<div id="headerWrapper">
	<div id="logoWrapper">
		...
		<div id="localeMenu">
			<a href="?language=us"><img alt="usa" src="<%= request.getParameter("pathToLocaleUSA") %>" width="32" height="32" /></a> 
			<a href="?language=ru"><img alt="ru" src="<%= request.getParameter("pathToLocaleRUS") %>" width="32" height="32" /></a>
		</div>	
