...
public class ViewController {
	...
	public String viewStatement(@ModelAttribute(ParameterConstants.PARAMETER_USER) User sessUser,
								@ModelAttribute(ParameterConstants.PARAMETER_GROUP) Group group, BindingResult result, Model model){
	...
	public String viewGroupsOfSporttype(@ModelAttribute ("sporttype") Sporttype sporttype, 
