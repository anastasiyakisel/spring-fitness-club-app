...
CREATE TABLE `SPORTTYPE` (
  `sporttype_id` bigint(12) NOT NULL,
...
CREATE TABLE `STATEMENT` (
  ...
  CONSTRAINT `FKardnmntaijku7to09mn35w0wv` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
...
INSERT INTO `STATEMENT` VALUES (12,1,2,5,60),(16,4,6,15,160),(17,2,4,9,130),(26,3,6,15,200),(27,5,7,20,184),(28,6,7,20,180),(29,7,4,9,115),(30,8,5,10,130),(31,9,4,9,115),(32,10,5,10,200),(33,11,5,10,126),(34,12,4,9,109),(35,13,4,9,155),(36,14,5,10,175),(37,15,4,9,109),(38,17,8,20,220),(39,16,3,7,70),(40,18,0,0,0);
...
CREATE TABLE `groups` (
  ...
  CONSTRAINT `FKf6gxd9bj9id88wnosoumnqcdl` FOREIGN KEY (`sporttype_id`) REFERENCES `sporttype` (`sporttype_id`),
...
INSERT INTO `groups` VALUES (1,5,15,'WE,SA','08:00:00',1,25,1),(2,4,25,'WE,SA','13:00:00',1,20,4),(3,1,15,'MO,WE,SA','09:00:00',1,30,2),(4,3,30,'TU,TH,SU','15:00:00',1,30,4),(5,6,20,'TU,FR','14:00:00',1,50,3),(6,2,30,'MO,FR','12:00:00',1,20,1),(7,7,15,'WE,TH,FR','09:00:00',1,30,8),(8,8,20,'TU,FR','19:00:00',1,30,2),(9,4,15,'WE,SA','15:00:00',2,40,13),(10,8,20,'TH,SU','21:00:00',1,25,3),(11,1,15,'WE,SA','14:00:00',1,20,4),(12,7,40,'MO,FR','12:00:00',1,25,4),(13,5,30,'TU,TH,SA','13:00:00',1,60,5),(14,3,25,'WE,SA','20:00:00',1,20,6),(15,4,20,'MO,FR','17:00:00',2,30,7),(16,4,15,'TU,SA','12:00:00',1,25,9),(17,6,20,'FR,SU','11:00:00',1,30,5),(18,8,30,'TU,TH','18:00:00',1,25,2);
...
INSERT INTO `persistent_logins` VALUES ('nastya','EKAH7jG8/y7JMcdDZQCVJw==','3SdXnwcajBYQPkHZcDpYTQ==','2016-10-29 11:01:51');
...
CREATE TABLE `registration` (
  ...
  CONSTRAINT `FKeuus0dbqeoppck86rrv8qbf95` FOREIGN KEY (`group_id`) REFERENCES `groups` (`group_id`),
  CONSTRAINT `FKkyuphiynxwt1mtlfsptc991sc` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
...
-- Dump completed on 2016-10-29 14:34:46
